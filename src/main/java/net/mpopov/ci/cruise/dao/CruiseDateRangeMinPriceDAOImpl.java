...
@Repository
public class CruiseDateRangeMinPriceDAOImpl implements CruiseDateRangeMinPriceDAO{
	...
	public List<CruiseDateRangeMinPrice> listCbrMinPrices(List<Long> excludedCompanyIds)
	{
